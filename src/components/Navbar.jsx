      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-8">
            ...
            <div className="hidden md:flex items-center space-x-1">
              ...
              <Link to="/faq" className="px-4 py-2 rounded-lg hover:bg-slate-700 transition-all duration-200 font-medium">
                My List
              </Link>
            </div>
          </div>
            ...
            <div className="hidden sm:block relative">
              <div className={`flex items-center transition-all duration-300 ${isSearchOpen ? 'w-64' : 'w-10'}`}>
                <button
                  ...
                  className="absolute left-0 p-2 hover:bg-slate-700 rounded-full transition-colors"
                >
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 space-y-2 animate-slideDown">
            ...
            <Link to="/faq" className="block px-4 py-2 rounded-lg hover:bg-slate-700 transition-colors">
              My List
            </Link>
            <div className="pt-2">
              <input
